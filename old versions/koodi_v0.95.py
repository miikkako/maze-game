...
class Mazematrix(object): 
    ...
    def addAstarsolution(self):
        ...
        #print('endcoord in astars beginning:', endcoord, 'startcoord:', startcoord)
        opencoordlist = []
        closedlist = []
        for j in range(self.height):
            for i in range(self.width):
        ...
        count = 0
        #print('closedlist in the start:', closedlist)
        #print('opencoordlist in the start:', opencoordlist)
        ...
        while count < 5000:
            ...
            for opencoord in opencoordlist:
                #print('for-loop,opencoord:',opencoord, ', opencoord_s f:',cellgrid[opencoord[0]][opencoord[1]].f)
            ...
            #print('\ncurrentcellcoord at',count,'while:', currentcellcoord, ', current_s f:', cellgrid[currentcellcoord[0]][currentcellcoord[1]].f)
            #print('opencoordlist:', opencoordlist, 'closedlist:', closedlist); print('\n\n')
            self.neighbours(currentcellcoord, cellgrid, opencoordlist, closedlist)

            if endcoord in closedlist or len(opencoordlist) == 0:
                break

        #print('count after first while-loop:',count)
        ...
        #print('count after second while-loop:',count2)
        #print('matrix after Astar:\n')
        #self.printselfmatrix()
...
def main(programnotdone):
    ...
    if done == 2:
        ...
        for i in range(40):
            pygame.draw.rect(screen, screencolor, (0, 0, width-40, height-100)) # blank the game field
